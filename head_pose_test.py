...
class MarkDetector:
    ...
    def __init__(self, saved_model='pose_model'):
        """Initialization"""
...
video = cv2.VideoCapture("images/NTHUDDD_dataset/Training_Evaluation_Dataset/Training Dataset/034/noglasses/nonsleepyCombination.avi")
